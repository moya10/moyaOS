...
i386-elf-gcc -static-libgcc -lgcc -ffreestanding -m32 -g -c "kernel.cpp" -o "Binaries/kernel.o"
i386-elf-gcc -static-libgcc -lgcc -ffreestanding -m32 -g -c "CPU/idt.cpp" -o "Binaries/idt.o"
i386-elf-gcc -static-libgcc -lgcc -ffreestanding -m32 -g -c "CPU/isr.cpp" -o "Binaries/isr.o" -I CPU
i386-elf-gcc -static-libgcc -lgcc -ffreestanding -m32 -g -c "CPU/irq.cpp" -o "Binaries/irq.o" -I CPU
i386-elf-gcc -static-libgcc -lgcc -ffreestanding -m32 -g -c "CPU/timer.cpp" -o "Binaries/timer.o" -I CPU
